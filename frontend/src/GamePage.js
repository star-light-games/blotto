            ...
            <div style={{ flex: 10 }}>
               ...
               <div
                ...
                >
                    ...
                    {!animating && !mulliganing && <Button variant="contained" color="primary" size="large" style={{ margin: '10px' }} onClick={replayAnimations} disabled={submittedMove || (secondsElapsed !== null && secondsElapsed <= 8)}>
                        <Typography variant="h6">
                            Replay animations
                        </Typography>
                    </Button>}
                    {!gameOver && !mulliganing && <ResetButton onReset={() => handleReset(true)} disabled={animating || submittedMove || gameOver || (secondsElapsed !== null && secondsElapsed <= 3)} />}
